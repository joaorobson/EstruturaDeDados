...
int main(){
    ...
    insereAlunoNaLista(&listaAlunos, aluno1, 1);
    insereAlunoNaLista(&listaAlunos, aluno2, 2);
    insereAlunoNaLista(&listaAlunos, aluno3, 3);
    insereAlunoNaLista(&listaAlunos, aluno4, 2);
    ...
    int posicao = buscaSequencialPorMatricula(&listaAlunos, 15424242);
